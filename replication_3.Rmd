...
# Note: could not find data to download for slavery-youth-parent file (Figure 6). 
```



```{r, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
# I think this calls the code from the panel-utils file.
...
ante.tab <- stargazer(cnty.dem.mortrate, cnty.dem.houses, cnty.aff.mortrate, cnty.aff.houses, cnty.resent.mortrate, cnty.resent.houses, type = "html",
...
cces.sum.tab <- stargazer(s.whites[,c("dem", "affirm", "resent", "age", "religion", "female", "inc.mid")], covariate.labels = c("Democratic Identification", "Support for Affirmative Action", "Racial Resentment", "Age", "Religious Importance", "Gender (Female = 1, Male = 0)", "Household Income (Bracket Midpoint)"), type = "html", header = FALSE, float = FALSE)
...
stargazer(sph.dem.full, sph.iv, sph.aff.full, sph.aff.iv, sph.resent.full,sph.resent.iv, type = "html",
...
ind.full.table <- stargazer(ind.dem.1860, ind.dem.full, ind.dem.context, ind.aff.1860, ind.aff.full, ind.aff.context, ind.resent.1860, ind.resent.full,ind.resent.context, type = "html",
...
int.full.table <- stargazer(ind.dem.int, ind.dem.context.int, ind.aff.int, ind.aff.context.int, ind.resent.int, ind.resent.context.int, type = "html",
...
livestock.tab <- stargazer(cnty.dem.civil.lstock, cnty.aff.civil.lstock, cnty.resent.civil.lstock, type = "html",keep = c("pslave1860","civil.des.lstock"), style = "apsr", omit.stat = c("ll", "adj.rsq", "F", "ser"), covariate.labels = c("Prop. Slave, 1860", "Livestock Value Loss, 1860-1870"), dep.var.labels = c("Prop. Democrat", "Affirm. Action", "Racial Resentment"), column.sep.width = "5pt", float = FALSE, header = FALSE, add.lines = list(rep("", 3), ch.row("State Fixed Effects", rep(TRUE, 3)), ch.row("1860 Covariates", rep(TRUE, 3)), rep("", 3)), multicolumn = FALSE)
livestock.tab[4]
...
ineq.tab <- stargazer(cnty.ineq40.full, cnty.ineq40.iv, cnty.ineq.full, cnty.ineq.iv, cnty.inc.full, cnty.inc.iv, type = "html",
          keep = "pslave1860", style = "apsr", omit.stat = c("ll", "adj.rsq", "F", "ser"),
...
ineq2.tab <- stargazer(ineq.dem, ineq.dem.full, ineq.aff, ineq.aff.full, ineq.resent, ineq.resent.full, type = "html", keep = c("wbincratio2014", "pslave1860"), style = "apsr", omit.stat = c("ll", "adj.rsq", "F", "ser"),
...
inc.int.tab <-  stargazer(ind.dem.inc, ind.aff.inc, ind.resent.inc, type = "html",
...
blkshrink.tab <- stargazer(cnty.dem.blkshrink, cnty.dem.blkshrink.70, cnty.aff.blkshrink, cnty.aff.blkshrink.70, cnty.resent.blkshrink, cnty.resent.blkshrink.70, type = "html",
